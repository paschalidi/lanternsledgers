...
const HOMEPAGE_ID = "anbkHRIAAC4AKWbc";

async function main() {
  console.log("Updating homepage via PUT...");
  const r = await fetch(`${API}/documents/${HOMEPAGE_ID}`, {
    method: "PUT",
    headers: {
  ...
  console.log("Homepage PUT:", r.status, t.slice(0, 300));
}
